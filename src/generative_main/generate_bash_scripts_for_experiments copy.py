...
def generate_scripts_for_benchmark(dirpath_output):
    ...
    params_benchmark = [
        ...
        },
        {
            ...
            "filepath_test": "/users/the/NER_MTB/timeset/my_code_result/input_data/rel_label_task/tddiscourse/test.json",
            "filepath_dev": "/users/the/NER_MTB/timeset/my_code_result/input_data/rel_label_task/tddiscourse/dev.json",
            "max_new_tokens": 64,
            "precision_type": "bfloat16",
        },
        {
            "dataset_name": "temporal-nli",
            "filepath_test": "/users/the/NER_MTB/timeset/my_code_result/input_data/tf_rel_task/temporal-nli/test.json",
            "filepath_dev": "/users/the/NER_MTB/timeset/my_code_result/input_data/tf_rel_task/temporal-nli/dev.json",
            "max_new_tokens": 64,
            "precision_type": "bfloat16",
        },
    ]

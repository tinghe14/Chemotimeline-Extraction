...
def read_files(args):
    ...
    if len(all_ids) == 0 or len(all_ids) != len(pred_all_patient):
        print(set(all_ids) - set(pred_all_patient))
        print(set(pred_all_patient) - set(all_ids))
        raise ValueError(
...
'''
# train, breast
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/breast_train_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_breast_train.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/breast_train_patient_ids.txt --strict

# train, melanoma
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/melanoma_train_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_melanoma_train.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/melanoma_train_patient_ids.txt --strict

# train, melanoma 

# dev, breast
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/breast_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_breast_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/breast_dev_patient_ids.txt --strict
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/breast_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_breast_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/breast_dev_patient_ids.txt --relaxed_to day
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/breast_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_breast_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/breast_dev_patient_ids.txt --relaxed_to month
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/breast_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_breast_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/breast_dev_patient_ids.txt --relaxed_to year

# dev, melanoma
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/melanoma_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_melanoma_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/melanoma_dev_patient_ids.txt --strict
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/melanoma_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_melanoma_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/melanoma_dev_patient_ids.txt --relaxed_to day
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/melanoma_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_melanoma_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/melanoma_dev_patient_ids.txt --relaxed_to month
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/melanoma_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_melanoma_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/melanoma_dev_patient_ids.txt --relaxed_to year

# dev, ovarian
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/ovarian_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_ovarian_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/ovarian_dev_patient_ids.txt --strict
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/ovarian_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_ovarian_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/ovarian_dev_patient_ids.txt --relaxed_to day
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/ovarian_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_ovarian_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/ovarian_dev_patient_ids.txt --relaxed_to month
python /users/the/NER_MTB/timelines/docker_output_to_timeline/eval_timeline.py --gold_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/Gold_Timelines_allPatients/ovarian_dev_all_patients_gold_timelines.json --pred_path /users/the/NER_MTB/timelines/docker_output_to_timeline/summarized_output/add_lookup/cleaned_ovarian_dev.json --all_id_path /users/the/NER_MTB/chemoTimelines2024_train_dev_labeled/subtask1/All_Patient_IDs/ovarian_dev_patient_ids.txt --relaxed_to year

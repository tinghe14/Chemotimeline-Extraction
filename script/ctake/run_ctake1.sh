...
#SBATCH -o /users/the/NER_MTB/my/1_change_n2space/0328_n2space_breast_test_task2.log
...
-i /users/the/NER_MTB/timelines/chemoTimelinesBaselineSystem/input/change_n2space_task2/input_breast_test_task2 \
